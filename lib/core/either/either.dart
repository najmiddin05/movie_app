...
class Left<L, R> extends Either<L, R> {
  ...
  @override
  Future<Either<L, TR>> mapAsync<TR>(FutureOr<TR> Function(R right) fnR) => Future<Either<L, TR>>.value(Left<L, TR>(value));

  @override
  Future<Either<TL, R>> mapLeftAsync<TL>(FutureOr<TL> Function(L left) fnL) => Future.value(fnL(value)).then(Left<TL, R>.new);
...
class Right<L, R> extends Either<L, R> {
  ...
  @override
  Future<Either<L, TR>> mapAsync<TR>(FutureOr<TR> Function(R right) fnR) => Future.value(fnR(value)).then(Right<L, TR>.new);
